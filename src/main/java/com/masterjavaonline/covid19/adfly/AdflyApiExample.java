package com.masterjavaonline.covid19.adfly;
...
public class AdflyApiExample {
	public static void main(String [] args) {
		...
		//)));
		System.out.println(formatJson(api.shorten("https://www.hindustantimes.com/india-news/kashmir-is-india-s-internal-matter-says-taliban-denies-plan-to-target-delhi/story-sOgG3yPsMenP4nZDKRbygL.html")));
